...
![Логотип RF-Pen](img/photo_logo.jpg)
...
![Отображение символов, вид #2](media/photo_font2.jpg)
...
### 1. Проектирование электроники (Schematics & PCB)
...
**Топология печатной платы (PCB Layout):**

![Печатная плата](img/pcb.png)

### 2. Сборка и пайка (Assembly & Soldering)
...
### 3. Разработка корпуса (Enclosure Design)
...
### 4. Программное обеспечение (Firmware & PC Toolchain)
...
Это был полный цикл "глубокого садомазохизма": от фрезеровки прототипа платы на ЧПУ до написания собственного загрузчика и утилит для ПК. Но именно такой подход позволил досконально изучить работу каждого компонента системы и получить бесценный опыт в разработке встраиваемых систем.
